...
import {Option, Search} from "lucide-react";
                ...
                <div className="card p-4 mb-4">
                    ...
                    <form className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-6 gap-4">
                        <div>
                            ...
                            <select value={type} id="type" className="w-full border rounded px-3 py-2"
                        ...
                        <div>
                            ...
                            <input value={endDate} id="enddate" type="date" className="w-full border rounded px-3 py-2"
                                   onChange={e => setEndDate(e.target.value)}/>
                        </div>
                        <div>
                            <label htmlFor="sortfield" className="block text-sm font-medium mb-1">Sort Field</label>
                            <select value={sortField} id="sortfield" className="w-full border rounded px-3 py-2"
                        ...
                        <div>
                            ...
                            <select value={sortOrder} id="sortorder" className="w-full border rounded px-3 py-2"

...
const Menubar = ({activeMenu}) => {
    ...
    return (
        <div className="flex items-center justify-between gap-5 bg-white border border-b-gray-200/50 backdrop-blur-[2px] px-4 py-4 sm:px-7 sticky top-0 z-30">
            ...
            <div className="relative" ref={dropdownRef}>
                ...
                {/*Dropdown menu*/}
                {showDropdown && (
                    <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border-b-gray-200 py-1 z-50">
                        {/* User info*/}
                        ...
                        <div className="py-1">
                            <button
                                onClick={handleLogout} className="flex items-center gap-3 w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors duration-150">
